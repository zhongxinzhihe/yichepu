...
// 随机字符串
  private function createNonceStr($length = 16) {
    ...
    public function template_msg($template_id,$openid,$data)
    {
      // $openid = 'ot1H9jktE7q1y2T7NWphCNgcuCcc';//青柠养车真
      $data['touser'] = $openid;

      // $data['template_id'] = 'Xmvnth64cHiXnT3g21eDnlAnN9GWMgveiQOsvN4HbJc';//真实
      // $data['template_id'] = 'UszoR92L4BeyaVqCXpIQcKLTzZvWx2iBW7F_AvsyA_w';//测试

...
class UpgradeLogic extends Model
{
    ...
    function  __construct() {
        ...
        $this->service_url = "http://service.imshop.com/index.php?m=Home&c=Index&a=checkVersionTp5";
        //$this->service_url = "http://service.imshop.com/index.php?m=Home&c=Index&a=checkVersionTp52";
    ...
    */
    ...
    public  function UpgradeLog($to_key_num){
        ...
        $vaules = array(                
         ...
         $url = "http://service.imshop.com/index.php?m=Home&c=Index&a=upgradeLog&".http_build_query($vaules);              

...
return	array(	
	...
	'shop'=>array('name'=>'商城','child'=>array(
			...
			array('name' => '分销','child' => array(
					...
					array('name' => '分销列表', 'act'=>'distributor_list', 'op'=>'Distribut'),
					array('name' => '分销商列表', 'act'=>'distributor_apply', 'op'=>'Distribut'),
			...
			array('name' => '设置','child' => array(
					array('name'=>'自定义网页导航栏','act'=>'navigationList','op'=>'System'),
					array('name'=>'清除网页缓存','act'=>'cleanCache','op'=>'System'),
					array('name'=>'轮播列表','act'=>'adList','op'=>'Ad'),
					array('name'=>'广告位置','act'=>'positionList','op'=>'Ad'),
			)),
				array('name' => '会员卡设置','child' => array(
				array('name' => '会员卡列表', 'act'=>'index', 'op'=>'Card'),
				array('name' => '会员卡类型', 'act'=>'card_type', 'op'=>'Card'),
				array('name' => '可选项目', 'act'=>'attribute', 'op'=>'Card'),
				array('name' => '套餐', 'act'=>'set_meal', 'op'=>'Card'),
	...
	'business'=>array('name'=>'商户','child'=>array(
			    array('name' => '商户','child' => array(
				array('name' => '商户列表', 'act'=>'index', 'op'=>'Business'),
				array('name' => '添加商户', 'act'=>'addEditBusiness', 'op'=>'Business'),

			)),
	)),
    
    'credit'=>array('name'=>'信用查询','child'=>array(
        array('name' => '信用查询','child' => array(
            array('name' => '客户列表', 'act'=>'index', 'op'=>'Credit'),
    
        )),
    )),
    

	'business_back'=>array('name'=>'商户后台','child'=>array(
			    array('name' => '商户后台','child' => array(
				array('name' => '商户验券列表', 'act'=>'checkList', 'op'=>'Business'),
				array('name' => '商户验券', 'act'=>'checkOrder', 'op'=>'Business'),
				array('name' => '修改密码', 'act'=>'changeSecret', 'op'=>'Business'),

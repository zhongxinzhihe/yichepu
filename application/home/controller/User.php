...
//            $this->verifyHandle('user_reg');
    ...
    public function order_detail(){
        ...
        //获取订单进度条
        // $sql = "SELECT action_id,log_time,status_desc,order_status FROM ((SELECT * FROM __PREFIX__order_action WHERE order_id = :id AND status_desc <>'0' ORDER BY action_id) AS a) GROUP BY status_desc ORDER BY action_id";
        // $bind['id'] = $id;

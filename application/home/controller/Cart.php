    ...
    */
    ...
    public function cart4(){
        ...
        if($order['pay_status'] == 1){            
            // $order_detail_url = U("Home/Cart/order_detail",array('id'=>$order_id));
             $order_detail_url = U("Home/Cart/paySuccess");
    ...
    public function area()
       ...
       {
        if($this->user_id == 0){
            $this->error('请登录',U('Home/LoginApi/login',array('oauth'=>'weixin')));
         // $jump_url = "http://".$_SERVER['HTTP_HOST']."/home/LoginApi/login/oauth/weixin.html";
